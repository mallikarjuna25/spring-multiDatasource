package com.brillio.liquibase.configuration;
...
@EnableJpaRepositories(entityManagerFactoryRef = "studentEntityManagerFactory",basePackages = {"com.brillio.liquibase.repository.studentRepo"},transactionManagerRef ="studentTransactionManager" )
public class StudentDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder, @Qualifier("studentDatasource") DataSource dataSource){
        ...
        return builder.dataSource(dataSource).properties(properties).packages("com.brillio.liquibase.model.student").persistenceUnit("Student").build();
    }
