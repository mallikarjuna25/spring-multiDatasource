...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",basePackages = {"com.brillio.liquibase.repository.employeeRepo"},transactionManagerRef ="transactionManager")
public class EmployeeDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder, @Qualifier("datasource") DataSource dataSource){
        ...
        return builder.dataSource(dataSource).properties(properties).packages("com.brillio.liquibase.model.employee").persistenceUnit("Employee").build();
    }
